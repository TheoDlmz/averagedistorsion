...
class ModelEuclideanMultiPoles(ModelEuclidean):
    ...
    def __init__(self, poles_num=3, phi=0.2, dim=2, norm=False, fixed=False, positions_irrelevant=None):
        super().__init__(dim=dim, norm=norm, fixed=fixed, positions_irrelevant=positions_irrelevant)
